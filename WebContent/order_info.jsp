...
<body>
	...
	<div class="container">
			...
			<div style="margin: 0 auto; margin-top: 10px; width: 950px;">
				...
				<table class="table table-bordered">
					<tbody>
						...
						<c:forEach items="${order.orderItem }" var="entry">
						<tr class="active">
							<td width="60" width="40%"><input type="hidden" name="id"
								value="22"> <img src="${pageContext.request.contextPath }/${entry.product.pimage }" width="70"
								height="60"></td>
							<td width="30%"><a target="_blank">${entry.product.pname }</a></td>
							<td width="20%">￥${entry.product.shop_price }</td>
							<td width="10%">${entry.count }</td>
							<td width="15%"><span class="subtotal">￥${entry.subtotal }</span></td>
						</tr>
						</c:forEach>
					</tbody>
				</table>
		...
		<div>
			<hr />
			<form id="orderForm" class="form-horizontal" action="${pageContext.request.contextPath }/order" method="post" style="margin-top: 5px; margin-left: 150px;">
